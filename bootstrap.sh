...
#   SDL_REPO       (default: /dartfs/rc/lab/S/SongL/EddieBae/sparse-dictionary-learning)
#                  NOTE: must match slurm/00_env.sh. The lab filesystem is used
#                  because $HOME (~50G) cannot hold the ~100GB of MLP activations
#                  generated by step 03; train.bin alone is 18GB.
